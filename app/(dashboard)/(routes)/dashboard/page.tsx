  ...
  return (
    <>
      <div className="mt-2 mb-8 flex flex-col items-center space-y-2">
        <Image src="/landing-hero.png" width={100} height={100} alt="main" className="rounded-full" />
        ...
        {tools.map((tool, index) => (
          <div key={index}>
            <Card
              ...
              key={tool.href}
              className="p-4 border-black/4 items-center flex justify-between hover:shadow-lg shadow-black/50 transition cursor-pointer"
            >
